...
This is the third paragraph. Wrap each paragraph with the paragraph tag to tell browsers to render the gaps.
      ...
      <div id="wd-lists">
        ...
        My favorite recipe (Sukiyaki):
        <ol id="wd-sukiyaki">
            <li>Get your favorite stew ingredients (meat, veggies, tofu, etc.)</li>
            <li>Get or make your own sukiyaki sauce</li>
            <li>Chop up ingredients to size of your liking</li>
            <li>Cook meat (with green onions if possible)</li>
            <li>Pour one bottle of sukiyaki sauce in pot with the meat</li>
            <li>Toss in the other ingredients</li>
            <li>Wait ~15-20 mins ensuring no overboiling</li>
            <li>Serve with rice or use udon noodles and enjoy!!</li>
        </ol>
      ...
      <div id="wd-tables">
        ...
        <table border={1} width="100%">
          ...
          <tbody>
            ...
            <tr> 
              <td>Q7</td>
              <td>Scopes and Closures</td>
              <td>3/17/21</td>
              <td>92</td>
            </tr>
            <tr> 
              <td>Q8</td>
              <td>Data Structures in JS</td>
              <td>3/24/21</td>
              <td>93</td>
            </tr>
            <tr> 
      ...
      Click <a href="https://github.com/nick-ashi/kambaz-next-js" id="wd-github">here</a> for my wd github repo<br />
