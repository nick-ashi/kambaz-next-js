   ...
   <Table striped>
    ...
    <tbody>
     <tr><td className="wd-full-name text-nowrap">
      ...
      <tr><td className="wd-full-name text-nowrap">
          <FaUserCircle className="me-2 fs-1 text-secondary" />
          <span className="wd-first-name">Iron</span>{" "}
      ...
      <td className="wd-login-id">001234561P</td>
      <td className="wd-section">S101</td>
      <td className="wd-role">PROFESSOR</td>
      <td className="wd-last-activity">2025-10-01</td>
      <td className="wd-total-activity">24:34:44</td></tr>
      <tr><td className="wd-full-name text-nowrap">
          <FaUserCircle className="me-2 fs-1 text-secondary" />
          <span className="wd-first-name">Pepper</span>{" "}
          <span className="wd-last-name">Potts</span></td>
